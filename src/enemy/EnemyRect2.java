...
public class EnemyRect2 extends Enemy{
	public EnemyRect2(int x, int y, int damage, Game game) {
		super(x, y, StatsLoader.getStat("EnemyRect2.damage"), game);
		this.setHealth(StatsLoader.getStat("EnemyRect2.health"));
		this.isRanged = true;
	}
