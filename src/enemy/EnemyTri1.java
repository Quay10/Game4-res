...
public class EnemyTri1 extends Enemy{
	public EnemyTri1(int x, int y,int damage, Game game) {
		super(x, y, StatsLoader.getStat("EnemyTri1.damage"), game);
		this.setHealth(StatsLoader.getStat("EnemyTri1.health"));
	}
